...
public class TreeMapDemo3 {
	public static void main(String[] args) {
		...
		System.out.println("TreeMap is empty before adding vales: "+ customerMap.isEmpty() );
		System.out.println("Size of TreeMap before adding values: "+ customerMap.size() );
		...
		System.out.println("TreeMap is empty after adding values: "+ customerMap.isEmpty() );
		System.out.println("Size of TreeMap after adding values: "+ customerMap.size() );
		...
		System.out.println("Value of Kumar is: " + e);
